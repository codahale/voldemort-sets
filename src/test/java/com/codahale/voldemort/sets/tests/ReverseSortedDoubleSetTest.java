...
import com.codahale.voldemort.sets.ReverseSortedDoubleSet;

@RunWith(Enclosed.class)
public class ReverseSortedDoubleSetTest {
	private static abstract class Context {
		protected Store<Object, byte[]> store;
		protected ReverseSortedDoubleSet view;
		
		@SuppressWarnings("unchecked")
		public void setup() throws Exception {
			this.store = mock(Store.class);
			this.view = new ReverseSortedDoubleSet();
		}
	}
