...
import com.codahale.voldemort.sets.ReverseSortedLongSet;

@RunWith(Enclosed.class)
public class ReverseSortedLongSetTest {
	private static abstract class Context {
		protected Store<Object, byte[]> store;
		protected ReverseSortedLongSet view;
		
		@SuppressWarnings("unchecked")
		public void setup() throws Exception {
			this.store = mock(Store.class);
			this.view = new ReverseSortedLongSet();
		}
	}
	...
	public static class Getting_A_Set extends Context {
		...
		@Test
		public void itConvertsTheExistingDataToACommaSeparatedList() throws Exception {
			assertThat(view.storeToView(store, "key", new byte[] { 2, 4, 6 })).isEqualTo("3,2,1");
		}
	}
